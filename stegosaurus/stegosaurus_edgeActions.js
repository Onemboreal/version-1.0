...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${planta3hojas_sym}", "mousedown", function(sym, e) {
         // insert code to be run when the mouse button is down
         theDepth += 1;
         sym.$("planta3hojas_sym").css({"position": "absolute", "z-index": theDepth});

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${planta3hojas_sym}", "mouseover", function(sym, e) {
         // insert code to be run when the mouse hovers over the object
         
         sym.getComposition().getStage().dragDrop("planta3hojas_sym","52px","518px");
      ...
      Symbol.bindElementAction(compId, symbolName, "${planta3hojas2_sym}", "mousedown", function(sym, e) {
         // insert code to be run when the mouse button is down
         theDepth += 1;
         sym.$("planta3hojas2_sym").css({"position": "absolute", "z-index": theDepth});

      });
      //Edge binding end

      Symbol.bindElementAction(compId, symbolName, "${planta3hojas2_sym}", "mouseover", function(sym, e) {
         // insert code to be run when the mouse hovers over the object
         sym.getComposition().getStage().dragDrop("planta3hojas2_sym","842px","606px");
      ...
      Symbol.bindElementAction(compId, symbolName, "${planta3hojas_sym}", "touchstart", function(sym, e) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${planta3hojas2_sym}", "touchstart", function(sym, e) {
         // insert code to be run when a user touches the object (for touch devices only)
         sym.getComposition().getStage().dragDrop("planta3hojas2_sym","842px","606px");
      ...
      Symbol.bindElementAction(compId, symbolName, "${planta3hojas2_sym}", "click", function(sym, e) {
         // insert code for mouse click here
   ...
   (function(symbolName) {   
      ...
      Symbol.bindElementAction(compId, symbolName, "${tacha_btn_factbox}", "touchstart", function(sym, e) {
         // insert code to be run when a user touches the object (for touch devices only)
         // Show elements 
         sym.getComposition().getStage().$("tacha_btn_sym").show();
         sym.getComposition().getStage().$("info_btn_sym").show();
